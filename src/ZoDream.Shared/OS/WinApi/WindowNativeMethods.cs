...
namespace ZoDream.Shared.OS.WinApi
{
    public static class WindowNativeMethods
    {
        ...
        public static extern bool GetWindowRect(IntPtr hWnd, ref RectStruct lpRect);
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool GetClientRect(IntPtr hWnd, ref RectStruct lpRect);

        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool ClientToScreen(IntPtr hWnd, ref PointStruct point);
        ...
        /// <returns></returns>
        [DllImport("user32.dll")]
        public extern static IntPtr WindowFromPoint(PointStruct point);
        ...
        public static RectStruct GetClientRect(IntPtr hwnd)
        {
